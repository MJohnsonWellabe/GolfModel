...
emit(timberlineWestV2, 'timberlinewest', 'src/data/courses/v2');
emit(sablebayV2, 'sablebay', 'src/data/courses/v2');
emit(portjohnsonV2, 'portjohnson', 'src/data/courses/v2');
