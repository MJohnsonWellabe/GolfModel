...
const redhollow = {
  ...
  theme: {
    ...
    treeKeys: [],
    scatterKeys: ['stone_a', 'stone_d', 'stone_e', 'bush_b'],
    sandPlantKeys: ['heather_fescue_a', 'stone_d', 'bush_b'],
    sandPlantStep: 96, sandPlantKeep: 0.35,
    sandSculpt: 0.25, bunkerDepthScale: 1.35,
    tuftDensity: 0.55, roughTuftHeight: 1.2,
