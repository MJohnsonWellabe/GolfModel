...
const CLIPS: Clip[] = [
  { badge: 'Par 3', title: 'Tee shot to the pin', sub: 'A cinematic tee shot with the payoff included.', poster: 'assets/marketing/img/poster-montage.png', file: 'assets/marketing/videos/montage.mp4' },
